...
def downgrade():
    op.drop_table('watchlist_stocks', schema='robin_96')
    op.drop_table('portfolio_stocks', schema='robin_96')
    op.drop_table('watchlists', schema='robin_96')
    op.drop_table('portfolios', schema='robin_96')
    op.drop_table('users', schema='robin_96')
    op.drop_table('stocks', schema='robin_96')
